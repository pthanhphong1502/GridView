...
@Component({
  selector: 'app-popup-waiting-register-approve',
  templateUrl: './popup-waiting-register-approve.component.html',
  styleUrls: ['./popup-waiting-register-approve.component.scss']
})
export class PopupWaitingRegisterApproveComponent extends UIComponent {
  EBasicSalaryObj: any;

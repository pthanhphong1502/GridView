import { ChangeDetectorRef, Component, ElementRef, EventEmitter, HostListener, Injector, OnInit, Optional, Output, ViewChild } from '@angular/core';
import {
  ButtonModel,
  CodxFormComponent,
  DataRequest,
...
@Component({
  ...
  templateUrl: './popu-menusidebar-reponsive.component.html',
  styleUrls: ['./popu-menusidebar-reponsive.component.scss']
})
export class PopuMenusidebarReponsiveComponent extends UIComponent
implements OnInit  {
  // formModel: FormModel;
  dialog: DialogRef;
  EBasicSalaryObj: any;
  ...
  constructor(
    ...
    console.log('dialog nè',  this.crrFuncTabNum)

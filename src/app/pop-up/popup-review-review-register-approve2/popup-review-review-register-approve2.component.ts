...
@Component({
  selector: 'app-popup-review-review-register-approve2',
  templateUrl: './popup-review-review-register-approve2.component.html',
  styleUrls: ['./popup-review-review-register-approve2.component.scss']
})
export class PopupReviewReviewRegisterApprove2Component extends UIComponent {
  EBasicSalaryObj: any;
